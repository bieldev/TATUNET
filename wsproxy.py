...
# encoding: utf-8
# CRAZY By @Crazy_vpn
import socket, threading, thread, select, signal, sys, time, getopt, resource
MSG = 'tatunet'
COR = '<font color="null">'
FTAG = '</font>'
PASS = ''
...
def main(host=LISTENING_ADDR, port=LISTENING_PORT):
    ...
    print "\033[0;34m━"*10,"\033[1;32m BIELDEV","\033[0;34m━\033[1;37m"*11,"\n"
    
    
    server = Server(LISTENING_ADDR, LISTENING_PORT)
    server.start()
    sys.setrecursionlimit(1024000)
    resource.setrlimit(resource.RLIMIT_NOFILE,(1024000,1024000))
